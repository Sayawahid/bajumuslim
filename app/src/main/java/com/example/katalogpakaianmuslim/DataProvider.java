...
public class DataProvider {
    ...
    private static List<Pria> initDataPria(Context ctx) {
        ...
        prias.add(new Pria("Gerai Hawa Yassar Hoodie Kurta", "Rp 200.000,00",
                "size : M, L, XL, XXL", R.drawable.aa));
        prias.add(new Pria("Aldebaran Amr Black", "Rp 120.000,00",
                "size : M, L, XL, XXL", R.drawable.aaa));
        prias.add(new Pria("Bunayya Gamis Krakatoa", "Rp 150.000,00",
                "size : M, L, XL, XXL", R.drawable.aaaa));
        prias.add(new Pria("Gerai Hawa Khalil Koko", "Rp 200.000,00",
    ...
    private static List<Wanita> initDataWanita(Context ctx) {
        ...
        wanitas.add(new Wanita("Havva Farani Kaftan White", "Rp 250.000,00",
                "size : M, L, XL, XXL", R.drawable.bb));
        wanitas.add(new Wanita("ALEZA Hevana Top", "Rp 200.000,00 ",
                "size : M, L, XL, XXL", R.drawable.bbb));
        wanitas.add(new Wanita("Kanaka Bia Stripped Blouse ", "Rp 300.000,00",
                "size : M, L, XL, XXL ", R.drawable.bbbb));
        wanitas.add(new Wanita("Mannequina Mirsya Jumpsuit di", "Rp 300.000,00",
